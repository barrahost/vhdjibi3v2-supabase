/*
  # Audio Teachings and Storage Configuration

  1. Tables
    - Creates audio_teachings table with RLS policies
    - Configures storage bucket for audio files
  
  2. Security
    - Enables RLS on both table and storage
    - Sets up appropriate policies for:
      - Public read access to active teachings
      - Service role full access
*/

-- Create audio_teachings table if it doesn't exist
