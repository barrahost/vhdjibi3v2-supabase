...
ALTER TABLE public.evangelized_souls
  ...
  ADD COLUMN IF NOT EXISTS original_soul_id text,
  ADD COLUMN IF NOT EXISTS imported_to_soul_id text,
  ADD COLUMN IF NOT EXISTS imported_from_evangelized_id text,
  ADD COLUMN IF NOT EXISTS imported_from_evangelist_id text,
