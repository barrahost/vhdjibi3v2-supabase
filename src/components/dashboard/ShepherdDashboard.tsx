    ...
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100">
        <div className="px-3 py-2.5 border-b flex items-center justify-between gap-2">
          <h2 className="text-sm sm:text-base font-semibold text-brand-700">Mes âmes — suivi</h2>
        ...
        <div className="divide-y max-h-[520px] overflow-y-auto">
          {soulsWithLastContact.length === 0 ? (
            ...
            soulsWithLastContact.map(soul => {
              ...
              return (
                <div key={soul.id} className="px-3 py-2.5 flex items-center gap-2">
                  {/* Avatar initiale */}
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-sm font-medium text-gray-900 truncate">
                      ...
                      {(soul as any).originSource === 'evangelisation' && (
                        <span className="ml-1.5 text-[10px] bg-teal-50 text-teal-700 px-1.5 py-0.5 rounded font-normal">évang.</span>
                      )}
                    </p>
                  ...
                  <div className="flex-shrink-0 flex items-center gap-1">
                    ...
                    <button
                      ...
                      className="inline-flex items-center justify-center w-7 h-7 bg-brand-700 text-white rounded-lg hover:bg-brand-800 transition-colors"
                      title="Enregistrer interaction"
                    >
      ...
      <div className="bg-white border border-gray-100 rounded-2xl p-3 sm:p-4 shadow-sm">
        <h3 className="font-semibold text-brand-700 text-sm mb-3">Progression spirituelle de mes âmes</h3>
        {[
